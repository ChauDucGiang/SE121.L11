            ...
            <div class="h-full">
                ...
                <component :is="scrollbarTag" class="scroll-area--customizer pt-4 pb-6" :settings="settings"
                    ...
                    <div class="px-6">
                        ...
                        <!--                                </ul>-->
                        <!--                            </div>-->
                        <!--                            &lt;!&ndash; /NAVBAR COLOR &ndash;&gt;-->

                        <!--                            <vs-divider/>-->

                        <!--                        </template>-->

                        <!--            &lt;!&ndash; NAVBAR TYPE &ndash;&gt;-->
                        <!--            <div class="mt-4">-->
                        ...
                        <!--            &lt;!&ndash; SHOW SCROLL TO TOP &ndash;&gt;-->
                        <!--            <div class="mt-4 flex justify-between">-->
