            ...
            <form action="">
                <vx-card class="mt-base" no-shadow card-border>
                    ...
                    <div class="vx-row">
                        ...
                        <div class="vx-col w-1/2">
                            <vs-select label="Category *" class="mt-5 w-full"
                                       :class="(!form.category_id)?'required':''" autocomplete
                ...
                <vx-card class="mt-base" no-shadow card-border>
                    ...
                    <div class="vx-row centerx">
                        <!--                        <img :src="set_avatar(img)" class="mr-8 rounded h-24 w-24" v-for="(img, i) in files"/>-->
                        <div class="vx-row centerx">
                            <!--                        <img :src="set_avatar(img)" class="mr-8 rounded h-24 w-24" v-for="(img, i) in files"/>-->
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                // this.form.forEach(function (value, key) {
                //   formData.append(key, value)
                // })
                this.$store
                    .dispatch("product/STORE_PRODUCT", formData)
        ...
        created() {
            this.$store.dispatch('product/CREATE_PRODUCT').catch(err => {
                console.error(err)
            })
        }
    }
