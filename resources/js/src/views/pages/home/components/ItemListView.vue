        ...
        <template slot="no-body">
            <div class="vx-row item-details no-gutter">
                ...
                <div
                    ...
                    <img :src="item.images[0]" :alt="item.name" class="grid-view-img p-4">
                </div>
                ...
                <div class="vx-col sm:w-1/2">
                    <div class="p-4 pt-6">
                        <slot name="item-meta">
                            ...
                            <p class="text-sm mb-4">Customer : <span class="font-semibold cursor-pointer">{{ item.code }}</span>
                            </p>
                ...
                <div
                    ...
                    <div class="p-4 flex flex-col w-full">
                        ...
                        <div class="text-warning flex self-end border border-solid border-warning py-1 px-2 rounded">
                            <span class="text-sm mr-1">Product code: {{ item.code }}</span>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            cartButtonClicked(item) {
                this.isInCart(item.objectID) ? this.$router.push('/apps/home/checkout').catch(() => {
                }) : this.additemInCart(item)
            },
            navigate_to_detail_view() {
                this.$router.push({name: 'home-item-detail-view', params: {item_id: this.item.objectID}})
                    .catch(() => {
                    })
            }
        }
